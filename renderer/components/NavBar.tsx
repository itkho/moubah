                        ...
                        <Listbox value={locale} onChange={setLocale}>
                            <div className="relative">
                                ...
                                <Transition
                                    ...
                                    leaveTo="opacity-0"
                                >
                                    <Listbox.Options className="absolute bottom-full z-10 mb-4 w-full overflow-auto rounded-md bg-base-100-light py-1 text-sm shadow-lg ring-1 ring-black ring-opacity-5">
